...
// document : HTML문서 내에서 
// getElementById : ID가 일치하는 HTML요소를 얻다.
...
function totalFn() {
    ...
    const value3 = Number(num1.value);
    const value4 = Number(num2.value);
    const value5 = Number(num3.value);
    total.innerText = value3 + value4 + value5;
}
...
// 문서 내에서 id가 "result2"인 요소를 얻어와 result2 변수에 대임
